...
// // // // int foo(pair<int,int> a, pair<int,int> b){
// // // //     if(a.first==b.first){
...
// // // //     int a=v.begin()->second;
// // // //     int b=(v.begin()++)->second;
// // // //     int c=v.rbegin()->first;
// // // //     int d=(v.rbegin()--)->first;
// // // //     deb(a);
// // // //     deb(b);
// // // //     deb(c);
// // // //     deb(d);
