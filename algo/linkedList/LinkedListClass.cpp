...
public:
    ...
    LinkedList(T A[], int n);         //Parameterised constructor
    ~LinkedList();
...
int main()
{
    ...
    cin>>key;
    Node<int>* n=l.ImprovedLsearch(key);
    cout<<"iLinearsearch n data= "<<n->data << ", next data= "<< n->next->data<<endl;
    l.display();
