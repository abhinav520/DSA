...
#define fiint(v,p) memset(v,p,sizeof(v))
...
#define setbits(x)  __builtin_popcountint(x) // returns number of 1-bits of x
#define trailing0(x) __builtin_ctzint(x) //returns num of trailing 0-bits of x
